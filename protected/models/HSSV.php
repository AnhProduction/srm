 ...
 * @property string $CMNDNgayCap
 * @property string $CMNDNoiCap
 ...
 */
class HSSV extends CActiveRecord
{
	/**
	...
	public function rules()
	{
		...
		return array(
			array('MaSV, HoDem, Ten, NgaySinh, NoiSinh, HKTT, DanToc, TonGiao, CMND, CMNDNgayCap, CMNDNoiCap, MaLop, MaNganh, HeDaoTao', 'required'),
			array('GioiTinh, NienKhoa', 'numerical', 'integerOnly'=>true),
			array('MaSV, HoDem, Ten, NgaySinh, DanToc, DoiTuong, TonGiao, NgayVaoDoan, NgayVaoDang, CMNDNgayCap, CMNDNoiCap, MaLop, MaNganh, HoTenBo, HoTenMe, NgheBo, NgheMe', 'length', 'max'=>50),
			array('NoiSinh', 'length', 'max'=>255),
			array('HKTT, HeDaoTao', 'length', 'max'=>10),
			array('CMND, SDT, SDTBo, SDTMe', 'length', 'max'=>20),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('SVID, MaSV, HoDem, Ten, NgaySinh, GioiTinh, NoiSinh, HKTT, DanToc, DoiTuong, TonGiao, NgayVaoDoan, NgayVaoDang, CMND, CMNDNgayCap, CMNDNoiCap, MaLop, MaNganh, NienKhoa, HeDaoTao, SDT, HoTenBo, HoTenMe, NgheBo, NgheMe, SDTBo, SDTMe', 'safe', 'on'=>'search'),
		);
	}
	...
	public function attributeLabels()
	{
		return array(
			...
			'CMND' => 'Cmnd',
			'CMNDNgayCap' => 'Cmndngay Cap',
			'CMNDNoiCap' => 'Cmndnoi Cap',
			'MaLop' => 'Ma Lop',
			'MaNganh' => 'Ma Nganh',
			'NienKhoa' => 'Nien Khoa',
			'HeDaoTao' => 'He Dao Tao',
	...
	public function search()
	{
		...
		$criteria->compare('NgayVaoDang',$this->NgayVaoDang,true);
		$criteria->compare('CMND',$this->CMND,true);
		$criteria->compare('CMNDNgayCap',$this->CMNDNgayCap,true);
		$criteria->compare('CMNDNoiCap',$this->CMNDNoiCap,true);
	 ...
	 * @return HSSV the static model class
	 */
